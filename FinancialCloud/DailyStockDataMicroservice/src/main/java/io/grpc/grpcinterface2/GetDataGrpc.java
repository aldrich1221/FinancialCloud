...
public final class GetDataGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.grpcinterface2.DataRequest,
      io.grpc.grpcinterface2.DataResponse> getGetDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetData",
      requestType = io.grpc.grpcinterface2.DataRequest.class,
      responseType = io.grpc.grpcinterface2.DataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.grpc.grpcinterface2.DataRequest,
      io.grpc.grpcinterface2.DataResponse> getGetDataMethod() {
    io.grpc.MethodDescriptor<io.grpc.grpcinterface2.DataRequest, io.grpc.grpcinterface2.DataResponse> getGetDataMethod;
      ...
      synchronized (GetDataGrpc.class) {
        if ((getGetDataMethod = GetDataGrpc.getGetDataMethod) == null) {
          GetDataGrpc.getGetDataMethod = getGetDataMethod =
              io.grpc.MethodDescriptor.<io.grpc.grpcinterface2.DataRequest, io.grpc.grpcinterface2.DataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.grpcinterface2.DataRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.grpcinterface2.DataResponse.getDefaultInstance()))
  ...
  public static abstract class GetDataImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getData(io.grpc.grpcinterface2.DataRequest request,
        io.grpc.stub.StreamObserver<io.grpc.grpcinterface2.DataResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.grpc.grpcinterface2.DataRequest,
                io.grpc.grpcinterface2.DataResponse>(
  ...
  public static final class GetDataBlockingStub extends io.grpc.stub.AbstractBlockingStub<GetDataBlockingStub> {
    ...
    /**
     */
    public io.grpc.grpcinterface2.DataResponse getData(io.grpc.grpcinterface2.DataRequest request) {
  ...
  public static final class GetDataFutureStub extends io.grpc.stub.AbstractFutureStub<GetDataFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.grpcinterface2.DataResponse> getData(
        io.grpc.grpcinterface2.DataRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DATA:
          serviceImpl.getData((io.grpc.grpcinterface2.DataRequest) request,
              (io.grpc.stub.StreamObserver<io.grpc.grpcinterface2.DataResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GetDataBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.grpc.grpcinterface2.GetDataProto2.getDescriptor();
    }
